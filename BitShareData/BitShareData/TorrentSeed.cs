...
{
    public partial class TorrentSeed
    {
        #region Primitive Properties
    
        public virtual int IdTorrentSeed
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.TorrentSeeds.Contains(this))
            {
                previousValue.TorrentSeeds.Remove(this);
            }
    
            if (Torrent != null)
            {
                if (!Torrent.TorrentSeeds.Contains(this))
                {
                    Torrent.TorrentSeeds.Add(this);
                }
            }
        }
        ...
        private void FixupUsuario(Usuario previousValue)
        {
            ...
            if (Usuario != null)
            {
                if (!Usuario.TorrentSeeds.Contains(this))
                {
                    Usuario.TorrentSeeds.Add(this);
                }
            }
        }
